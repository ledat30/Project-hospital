...
class Contact extends Component {
    ...
    handleSubmit = async (event) => {
        ...
        // Gửi dữ liệu liên hệ đến máy chủ Node.js
        try {
            ...
            <div>
                ...
                <div className="container7 d-flex justify-content-center align-items-center">
                    ...
                    <form onSubmit={this.handleSubmit}>
                        <h1 className="title9 text-center mb-4"><FormattedMessage id={'manage-contact.title3'} /></h1>
                        ...
                        <div className="text-center">
                            <button type="submit" className="btn btn-primary1" tabIndex="-1"><FormattedMessage id={'manage-contact.bt'} />
                            </button>
                        </div>
                    </form>
                </div>
