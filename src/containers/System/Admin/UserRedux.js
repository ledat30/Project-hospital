...
class UserRedux extends Component {
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        if (prevProps.genderRedux !== this.props.genderRedux) {
            ...
            this.setState({
                ...
                gender: arrGenders && arrGenders.length > 0 ? arrGenders[0].id : ''
            })
        }
        if (prevProps.roleRedux !== this.props.roleRedux) {
            ...
            this.setState({
                roleArr: arrRoles,
                role: arrRoles && arrRoles.length > 0 ? arrRoles[0].id : ''
            })
        }
        if (prevProps.positionRedux !== this.props.positionRedux) {
            ...
            this.setState({
                ...
                position: arrPositions && arrPositions.length > 0 ? arrPositions[0].id : ''
            })
        }
    ...
    render() {
        ...
        let { email, password, fullName, phonenumber, address, gender, position, role, avatar } = this.state;
        return (
            <div className='user-redux-container'>
                <div className='title my-4'><FormattedMessage id="manage-user.add" /></div>
